...
class MockCryptoMarket extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Markets", style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.bold)),
  ...
  Widget _buildMarketCard(String name, String symbol, String price, String change) {
          ...
          Expanded(
             child: Column(
               ...
               children: [
                 ...
                 Text(symbol, style: GoogleFonts.inter(color: Colors.white54, fontSize: 12)),
               ],
             )
          ),
          // Mini Chart Placeholder
          Container(width: 60, height: 30, color: isUp ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1)),
           ...
           Column(
             ...
             children: [
               ...
               Container(
                 ...
                 child: Text(change, style: GoogleFonts.inter(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
               )
             ],
           )
        ],
