...
class GenerationDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GenerationDetailScreen> createState() => _GenerationDetailScreenState();
}

class _GenerationDetailScreenState extends ConsumerState<GenerationDetailScreen> {
      ...
      default:
        return Center(
          child: Text(
              ...
              style: GoogleFonts.inter(color: const Color(0xFF71717A)) // zinc-400
          ),
        );
    }
  }
            ...
            Widget buildContextPanel() {
              return Container(
                decoration: BoxDecoration(
                    border: Border(
                      right: isMobile ? BorderSide.none : const BorderSide(color: Color(0xFF27272A)), // zinc-800
                      bottom: isMobile ? const BorderSide(color: Color(0xFF27272A)) : BorderSide.none,
                    )
                ),
                child: Stack(
                  fit: StackFit.expand,
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              IconButton(
                                icon: const Icon(Icons.menu, color: Color(0xFFA1A1AA)), // zinc-400
                              ...
                              const Icon(Icons.share_outlined, color: Colors.indigo, size: 20),
                              const SizedBox(width: 16),
                              const CircleAvatar(radius: 12, backgroundImage: NetworkImage("https://i.pravatar.cc/150?u=a042581f4e29026704d"))
                            ],
                          ),
                        ),
                          ...
                          child: ListView(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  const CircleAvatar(radius: 14, backgroundColor: Colors.indigo, child: Icon(Icons.auto_awesome, size: 14, color: Colors.white)),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Sketch", style: GoogleFonts.manrope(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                                        const SizedBox(height: 6),
                                        Text(
                                          "I've generated the screens based on your request. The design features a modern noir theme with indigo accents.",
                                          style: GoogleFonts.manrope(color: const Color(0xFFD4D4D8), fontSize: 14, height: 1.5), // zinc-300
                                        ),
                                      ],
                                    ),
                                  )
                              ...
                              if (isGenerating) ...[
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 12),
                                    Text("Generating variations...", style: GoogleFonts.manrope(color: const Color(0xFF71717A), fontSize: 13))
                                  ],
                                )
                              ]
                            ],
                            ...
                            children: [
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: GoogleFonts.manrope(color: const Color(0xFF52525B)), // zinc-500
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.add, color: Color(0xFFA1A1AA), size: 20),
                                  const SizedBox(width: 12),
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text("3x", style: GoogleFonts.manrope(color: Colors.white, fontSize: 11)),
                                      ],
                                    ),
                                  ),
                                  const Spacer(),
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Row(
                          ...
                          children: (data?['screens'] as List?)?.map<Widget>((screen) {
                            ...
                            return Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: const Color(0xFF27272A), width: 4), // zinc-800
                                    boxShadow: [
                                      BoxShadow(color: Colors.black.withOpacity(0.5), blurRadius: 50, offset: const Offset(0, 20))
                                    ]
                                ),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text("9:41", style: GoogleFonts.manrope(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 14)),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            _buildCanvasControl(Icons.pan_tool_outlined, CanvasTool.pan),
                            Container(width: 1, height: 24, color: const Color(0xFF27272A), margin: const EdgeInsets.symmetric(horizontal: 12)),
                            _buildCanvasControl(Icons.search, CanvasTool.zoom),
                            const SizedBox(width: 8),
                            _buildCanvasControl(Icons.image_outlined, CanvasTool.media),
                          ],
                        ),
                      ),
                    ),
              ...
              return Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const CircleAvatar(radius: 12, backgroundColor: Colors.indigo, child: Icon(Icons.auto_awesome, size: 12, color: Colors.white)),
                              const SizedBox(width: 8),
                              Text("Sketch", style: GoogleFonts.manrope(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                              const Spacer(),
                              Text("V 2.0", style: GoogleFonts.manrope(color: const Color(0xFF52525B), fontSize: 12)),
                            ],
                          ),
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: GoogleFonts.manrope(color: const Color(0xFF52525B)),
                                      border: InputBorder.none,
                                    ),
                                  ),
                                ),
                                IconButton(
                                  icon: const Icon(Icons.arrow_upward_rounded, color: Colors.indigo),
                                  onPressed: () {},
                                )
                              ],
                            ),
                    ...
                    ).animate().slideY(begin: 1, end: 0, duration: 400.ms, curve: Curves.easeOutExpo),
                  )
                ],
              );
            } else {
  ...
  Widget _buildCanvasControl(IconData icon, CanvasTool tool) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, color: isActive ? Colors.white : const Color(0xFFA1A1AA), size: 20),
      ),
    );
  }
}